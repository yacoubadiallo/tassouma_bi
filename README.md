...
=======
🚀 Tassouma Sales Analytics | Modern Data Stack (ELT)
>>>>>>> 53e385ffd32adc9ec445294a6377f4194bb70111
...
Vue d'ensemble (CA & Top Produits)Analyse Détaillée

Stack Technique & ExpertiseIngestion & Infras : Docker, Airflow, MinIO (S3-API).Processing : Python, Apache Spark (Lake-to-Warehouse).Data Modeling : dbt (Versioning SQL, tests de schémas, couches Bronze/Silver/Gold).
>>>>>>> 53e385ffd32adc9ec445294a6377f4194bb70111

Storage : PostgreSQL & MySQL.BI : Metabase (SQL interactif).🚀 Quick Start (Déploiement)Cloner le repository :Bashgit clone [https://github.com/yacoubadiallo/tassouma_bi.git](https://github.com/yacoubadiallo/tassouma_bi.git)
cd tassouma_bi
